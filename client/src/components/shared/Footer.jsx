...
const Footer = () => {
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-20">
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
          ...
          <p className="mt-6 text-sm">
            ...
            <br />
            <span className="text-[#5044E5]">Start creating now</span>
          </p>
        </div>
          ...
          <div>
            ...
            <div className="text-sm space-y-2">
              ...
              <div className="flex items-center gap-2 pt-4">
                ...
                ></input>
                <button className="bg-[#5044E5] w-24 h-9 text-white rounded">
                  Subscribe
                </button>
              </div>
            </div>
